...
async def test_neo4j_recommendations_endpoint():
    async with AsyncClient(transport=ASGITransport(app=app), base_url="http://test") as client:
        ...
        popular_resp = await client.get("/api/neo4j/products/popular", params={"limit": 1})
        ...
        rec_resp = await client.get(f"/api/neo4j/products/{product_id}/recommendations", params={"limit": 5})
